...
//SDMMC_LL_Clock_Edge Clock Edge
...
// SDMMC_LL_Clock_Power_Save Clock Power Saving
...
// SDMMC_LL_Hardware_Flow_Control Hardware Flow Control
...
// SDMMC_LL_Clock_Division Clock Division
#if defined(STM32L4R5xx) || defined(STM32L4R7xx) || defined(STM32L4R9xx) || defined(STM32L4S5xx) || defined(STM32L4S7xx) || defined(STM32L4S9xx)
...
// SDMMC_LL_Transceiver Transceiver
...
// SDMMC_LL_Command_Index Command Index
...
// SDMMC_LL_Wait_Interrupt_State Wait Interrupt
...
// SDMMC_LL_CPSM_State CPSM State
...
// SDMMC_LL_Response_Registers Response Register
...
// SDMMC_LL_Data_Length Data Lenght
#define IS_SDMMC_DATA_LENGTH(LENGTH) ((LENGTH) <= 0x01FFFFFF)


// SDMMC_LL_Data_Block_Size  Data Block Size
...
// SDMMC_LL_Transfer_Direction Transfer Direction
...
// SDMMC_LL_Transfer_Type Transfer Type
...
// SDMMC_LL_DPSM_State DPSM State
...
// SDMMC_LL_Read_Wait_Mode Read Wait Mode
...
// SDMMC_LL_Interrupt_sources Interrupt Sources
...
// SDMMC_LL_Interrupt_Clock Interrupt And Clock Configuration
#if !defined(STM32L4R5xx) && !defined(STM32L4R7xx) && !defined(STM32L4R9xx) && !defined(STM32L4S5xx) && !defined(STM32L4S7xx) && !defined(STM32L4S9xx)
